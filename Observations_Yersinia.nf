...
workflow {
    ...
    bam_files = Channel.fromPath("${params.output_bam}/${params.species}*.bam")

    // Just extract the mapped reads 
    ExtractReads(bam_files)

    fq_file = ExtractReads.out.read_file.flatten()
